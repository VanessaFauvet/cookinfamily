...
<div class="px-4 pt-5 my-5 text-center">
    ...
    <div class="overflow-hidden">
        <div class="container px-5">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/01.jpg" class="img-fluid border rounded-3 shadow-lg mb-4" alt="<?php _e('La cuisine pour tous !', 'cookinfamily'); ?>" loading="lazy" width="900" height="520" />
        </div>
    </div>
</div>
